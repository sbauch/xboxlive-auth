...
exports.preAuth = () => axios_1.default
    .get(`${config_1.default.uris.authorize}?${query_string_1.stringify(Object.assign({}, config_1.default.queries.authorize))}`, { headers: config_2.default.request.baseHeaders })
    .then(response => {
...
exports.logUser = (preAuthResponse, credentials) => axios_1.default
    .post(preAuthResponse.matches.urlPost, query_string_1.stringify({
    ...
    const parseHash = query_string_1.parse(hash);
